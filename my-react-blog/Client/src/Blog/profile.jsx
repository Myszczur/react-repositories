...
function Profile() {
                ...
                subheader={
                    <div className='FlexColumn'>
                        ...
                        <div className='FlexRow'>
                            ...
                            <button onClick={() => handleClickOpen(post.post.pid)}>Delete</button>
                        </div>
                    </div>
                }
            />
    ...
    return (
        <>
            <div>
                <RenderPrfile profile={context.profileState} />
            </div>
            <div>
                {stateLocal.posts
            ...
            <Dialog
                ...
                <DialogContent>
                    <DialogContentText id='alert-dialog-description'>Deleteing Post</DialogContentText>
                    <DialogActions>
